...
public class ModItemGroup {
    ...
    public static final RegistryKey<ItemGroup> BLOCKS_GROUP =
            RegistryKey.of(RegistryKeys.ITEM_GROUP, TvStudio.id("studio_blocks"));
    public static final RegistryKey<ItemGroup> ITEMS_GROUP =
            RegistryKey.of(RegistryKeys.ITEM_GROUP, TvStudio.id("studio_items"));
    public static final RegistryKey<ItemGroup> SET_WALL_GROUP =
            RegistryKey.of(RegistryKeys.ITEM_GROUP, TvStudio.id("studio_set_walls"));



    public static void registerItemGroups() {
        Registry.register(Registries.ITEM_GROUP, BLOCKS_GROUP,
                FabricItemGroup.builder()
                        .displayName(Text.translatable(Util.createTranslationKey("itemGroup", BLOCKS_GROUP.getValue())))
        ...
        Registry.register(Registries.ITEM_GROUP, ITEMS_GROUP,
                FabricItemGroup.builder()
                        .displayName(Text.translatable(Util.createTranslationKey("itemGroup", ITEMS_GROUP.getValue())))
                        .entries((displayContext, entries) -> {
        ...
        Registry.register(Registries.ITEM_GROUP, SET_WALL_GROUP,
                FabricItemGroup.builder()
                        .displayName(Text.translatable(Util.createTranslationKey("itemGroup", SET_WALL_GROUP.getValue())))
                        .entries((displayContext, entries) -> {
                            ...
                            entries.add(ModBlocks.SET_WALL_CHERRY_LOG);
                            entries.add(ModBlocks.SET_WALL_STRIPPED_CHERRY_LOG);
                            entries.add(ModBlocks.SET_WALL_CHERRY_PLANKS);
                            entries.add(ModBlocks.SET_WALL_BLOCK_OF_BAMBOO);
                            entries.add(ModBlocks.SET_WALL_BLOCK_OF_STRIPPED_BAMBOO);
                            entries.add(ModBlocks.SET_WALL_BAMBOO_PLANKS);
                            entries.add(ModBlocks.SET_WALL_BAMBOO_MOSAIC);
                            ...
                            entries.add(ModBlocks.SET_WALL_SUSPICIOUS_GRAVEL);
                            entries.add(ModBlocks.SET_WALL_SAND);
                            entries.add(ModBlocks.SET_WALL_SUSPICIOUS_SAND);
                            ...
                            entries.add(ModBlocks.SET_WALL_CHISELED_BOOKSHELF);
                        ...
                        .icon(() -> {
                            ItemStack stack = new ItemStack(ModBlocks.SET_WALL);
                                return stack;
                         })
                        .build());
    }
