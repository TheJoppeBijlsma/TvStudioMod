...
public final class ScreenWallBlock extends PaintableConnectingBlock {

	public ScreenWallBlock(Settings settings) {
		super(1.0F, 1.0F, 16.0F, 16.0F, 16.0F, Settings.create().breakInstantly().sounds(BlockSoundGroup.STONE).luminance((state) -> {
			return 2;}));
	...
	public final boolean connectsTo(BlockState state, boolean sideSolidFullSquare) {
		return !cannotConnect(state) && sideSolidFullSquare || state.getBlock() instanceof ScreenWallBlock;
	}
