...
//Blocks with BlockItem
	...
	public static final Block BLUE_SCREEN_BLOCK = registerBlock("blue_screen_block",
		new Block(FabricBlockSettings.create(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)), ModItemGroup.BLOCKS_GROUP);
	...
	public static final Block BLUE_SCREEN_WALL = registerBlock("blue_screen_wall",
			new WallBlock(FabricBlockSettings.create(Material.WOOL).breakInstantly().sounds(BlockSoundGroup.METAL)), ModItemGroup.BLOCKS_GROUP);
	...
	//Non-Coloured
		...
		public static final Block CHIPBOARD_BLOCK = registerBlock("chipboard_block",
			new Block(FabricBlockSettings.create(Material.WOOD).strength(3f, 3f).sounds(BlockSoundGroup.WOOD)), ModItemGroup.BLOCKS_GROUP);
